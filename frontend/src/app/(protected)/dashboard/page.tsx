...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Restaurant Group Operations Dashboard"
      subtitle="One merged restaurant group operations view for Customers, Orders, Catalog, Inventory, Pricing, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared restaurant group operations jobs into one surface. Customers, Orders, Catalog, Inventory, Pricing, Promotions, documents, audit, and AI are presented as platform features.</div>
