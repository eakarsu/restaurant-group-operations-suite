export const AUTH_COOKIE = 'restaurant_group_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@restaurant-group-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@restaurant-group-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@restaurant-group-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
