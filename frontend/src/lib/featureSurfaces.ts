...
const featureSeeds = [
  ['records', 'Customers', 'Customers operating queue', 'Commerce Lead', 'Review and assign next action'],
  ...
  ['fulfillment', 'Fulfillment', 'Fulfillment operating queue', 'Operations Lead', 'Review and assign next action'],
  ...
  ["recipe-planner","Recipe Planner","Recipe Planner review queue","Recipe Menu Planning","Review source context and assign owner"],
  ["menu-digitizer","Menu Digitizer","Menu Digitizer review queue","Recipe Menu Planning","Confirm next action and update evidence"],
  ["food-costing","Food Costing","Food Costing review queue","Recipe Menu Planning","Confirm next action and update evidence"],
  ["nutrition-menu-labels","Nutrition/Menu Labels","Nutrition/Menu Labels review queue","Recipe Menu Planning","Confirm next action and update evidence"],
  ["wine-spirits-inventory","Wine & Spirits Inventory","Wine & Spirits Inventory review queue","Wine Spirits Inventory Sommelier","Review source context and assign owner"],
  ["sommelier-pairing","Sommelier Pairing","Sommelier Pairing review queue","Wine Spirits Inventory Sommelier","Confirm next action and update evidence"],
  ["beverage-margin-review","Beverage Margin Review","Beverage Margin Review review queue","Wine Spirits Inventory Sommelier","Confirm next action and update evidence"],
