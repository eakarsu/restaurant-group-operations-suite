...
const entitySeeds = [
  ['records', 'Customers Records', 'Customers priority queue', 'Open', 'Customers exception list', 'Commerce Lead', '$0'],
  ['orders', 'Orders Records', 'Orders priority queue', 'Review', 'Orders exception list', 'Commerce Lead', '$0'],
  ['catalog', 'Catalog Records', 'Catalog priority queue', 'Action needed', 'Catalog exception list', 'Commerce Lead', '$0'],
  ['inventory', 'Inventory Records', 'Inventory priority queue', 'Open', 'Inventory exception list', 'Commerce Lead', '$0'],
  ['pricing', 'Pricing Records', 'Pricing priority queue', 'Review', 'Pricing exception list', 'Operations Lead', '$0'],
  ['promotions', 'Promotions Records', 'Promotions priority queue', 'Action needed', 'Promotions exception list', 'Operations Lead', '$0'],
  ['fulfillment', 'Fulfillment Records', 'Fulfillment priority queue', 'Open', 'Fulfillment exception list', 'Operations Lead', '$0'],
  ['returns', 'Returns Records', 'Returns priority queue', 'Review', 'Returns exception list', 'Operations Lead', '$0'],
  ['exceptions', 'Exceptions Records', 'Exceptions priority queue', 'Action needed', 'Exceptions exception list', 'Governance Lead', '$0'],
  ['reviews', 'Reviews Records', 'Reviews priority queue', 'Open', 'Reviews exception list', 'Governance Lead', '$0'],
  ...
  ["recipe-planner","Recipe Planner Records","Recipe Planner operating queue","Open","Recipe Planner follow-up list","Recipe Menu Planning","$0"],
  ["menu-digitizer","Menu Digitizer Records","Menu Digitizer operating queue","Review","Menu Digitizer follow-up list","Recipe Menu Planning","$0"],
  ["food-costing","Food Costing Records","Food Costing operating queue","Review","Food Costing follow-up list","Recipe Menu Planning","$0"],
  ["nutrition-menu-labels","Nutrition/Menu Labels Records","Nutrition/Menu Labels operating queue","Review","Nutrition/Menu Labels follow-up list","Recipe Menu Planning","$0"],
  ["wine-spirits-inventory","Wine & Spirits Inventory Records","Wine & Spirits Inventory operating queue","Open","Wine & Spirits Inventory follow-up list","Wine Spirits Inventory Sommelier","$0"],
  ["sommelier-pairing","Sommelier Pairing Records","Sommelier Pairing operating queue","Review","Sommelier Pairing follow-up list","Wine Spirits Inventory Sommelier","$0"],
  ["beverage-margin-review","Beverage Margin Review Records","Beverage Margin Review operating queue","Review","Beverage Margin Review follow-up list","Wine Spirits Inventory Sommelier","$0"],
