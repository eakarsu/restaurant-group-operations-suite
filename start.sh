...
PORT="${PORT:-5320}"
DB_NAME="${PGDATABASE:-restaurant_group_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Restaurant Group Operations Suite"
echo "======================================="
echo
...
echo "Starting restaurant group operations suite frontend on http://localhost:$PORT"
echo "Login: admin@restaurant-group-operations.local / admin123"
